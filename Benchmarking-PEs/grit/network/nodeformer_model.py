...
class NodeFormer(torch.nn.Module):
    '''
        NodeFormer
    '''
    ...
    def __init__(self, dim_in, dim_out):
        ...
        for l in range(cfg.gt.layers):
            layers.append(TransformerLayer(
                ...
                hid_dim=cfg.gt.dim_hidden,
                out_dim=cfg.gt.dim_hidden,
                num_heads=cfg.gt.n_heads,
                dropout=cfg.gt.dropout,
                num_layers=cfg.gt.num_layers,
                use_bn=cfg.gt.use_bn,
                use_residual=cfg.gt.use_residual,
                use_act=cfg.gt.use_act,
                use_jk=cfg.gt.use_jk,
                use_edge_loss=cfg.gt.use_edge_loss
            ))
        # layers = []
