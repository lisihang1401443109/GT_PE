...
@register_network('GraphiT')
class GraphiT(torch.nn.Module):
    '''
        DIFFormer
    '''
    ...
    def __init__(self, dim_in, dim_out):
        ...
        global_model_type = cfg.gt.get('layer_type', "GraphiT")
        ...
        for l in range(cfg.gt.layers):
            layers.append(TransformerLayer(
                ...
                d_model=cfg.gt.dim_hidden, # out_dim
                nb_heads=cfg.gt.n_heads,
            ))
        # layers = []
